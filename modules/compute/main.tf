...
resource "azurerm_linux_virtual_machine" "vulnerable_vm" {
  ...
  # admin_password removed; use SSH keys or a secure secret reference instead

  # DRIFT PROFILE REMEDIATED: Password authentication is disabled in favor of SSH keys
